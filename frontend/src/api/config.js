...
export const ENDPOINTS = {
    ...
    USERS: {
        ...
        SKILLS: '/users/me/skills',
        UPDATE_SKILLS: (userId) => `/users/${userId}/skills`,
        UPLOAD_RESUME: '/users/me/resume',
        GET_RESUME: '/users/me/resume',
        DELETE_RESUME: '/users/me/resume',
    },
    ...
    INTERVIEWS: {
        ...
        // Text answer endpoint
        SUBMIT_TEXT_ANSWER: (sessionId, questionId) => `/interviews/${sessionId}/questions/${questionId}/text-answer`,
    ...
    FEEDBACK: {
        CALCULATE_SCORES: (sessionId) => `/feedback/score/${sessionId}`,
        GET_SCORES: (sessionId) => `/feedback/sessions/${sessionId}/scores`,
        GENERATE_FEEDBACK: (sessionId) => `/feedback/generate/${sessionId}`,
