...
function InterviewPage() {
    ...
    const handleSubmit = async () => {
        ...
        // Determine interview_type from selected question types
        let interview_type = 'mixed';
        if (formData.question_types.length === 1) {
            interview_type = formData.question_types[0];
        }

        // Create session with selected question categories
        const sessionResult = await interviewApi.createSession({
            ...
            interview_type,
            skills_tested: formData.skills,
            total_questions: formData.num_questions,
